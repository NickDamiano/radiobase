...
module.exports = {
	getBio: function(artistObj,artist,callback){
		...
		var url = "http://developer.echonest.com/api/v4/artist/biographies?api_key=8335ceeafe655f7369e65ac441db26ea&name=" + artist + "&format=json&results=1&start=0&license=cc-by-sa";
